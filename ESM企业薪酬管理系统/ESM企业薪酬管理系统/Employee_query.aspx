<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_query.aspx.cs" Inherits="ESM企业薪酬管理系统.Employee_query" %>
                ...
                <tr>
                    <td width="240" valign="top">
                        <div id="sub_navigation">
                            <h2>员工信息管理</h2>
                            <p>管理员对员工的添加,删除,修改功能</p>
                            <ul class="sub_navigation_links">
                                <li><asp:HyperLink ID="lnkEmployeeMaintain" runat="server" NavigateUrl="Employee_query.aspx">员工列表维护</asp:HyperLink></li>
                            </ul>
                        </div>
                    </td>
                        ...
                        <div id="sub_body">
                            ...
                            <div id="function_button">
                                <div id="item_noline" class="blue_btn">
                                   <%--<a href="Employee_add.aspx">新建员工</a>--%>
                                    <h1>员工列表</h1>
                                     <asp:LinkButton ID="CreateEmployee" runat="server" OnClick="tzym">新建员工</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                    <asp:LinkButton ID="lnkDeleteEmployee" runat="server"  OnClientClick="return confirm('确定要删除选中的员工吗？');" OnClick="lnkDelete_Click">删除员工</asp:LinkButton>&nbsp;
                            ...
                            <div id="user_list">
                                <asp:GridView ID="gvEmployees" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="table_header_td" ItemStyle-CssClass="table_dashedline_td">
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="table_header_td" ItemStyle-CssClass="table_dashedline_td" ItemStyle-Width="60">
                                            <ItemTemplate>
                                                <a href="<%# "Employee_moreinfo.aspx?empId=" + Eval("empId").ToString() %>" ><img src="image/icon_view.png" border="0" alt="查看" /></a>
                                                 <asp:HyperLink ID="editLink" runat="server" NavigateUrl='<%# "Employee_update.aspx?empId=" + Eval("empId").ToString() %>'>
