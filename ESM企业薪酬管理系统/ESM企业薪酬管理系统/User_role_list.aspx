<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_role_list.aspx.cs" Inherits="ESM企业薪酬管理系统.User_role_list" %>
                        ...
                        <div id="sub_body">
                            <div id="this_page_title">
                                <fieldset class="pmsform">
                                    <h1 id="sub_title">用户信息查询>></h1>
                                    <div>
                                        <label class="pmsform">用户名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div id="function_button">
                                <div id="item_noline" class="blue_btn">
                                    <label class="pmsform">用户信息列表&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" OnClick="lnkDelete_Click" OnClientClick="return confirm('确定要删除选中的用户吗？');">删除用户</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="lnkModifyRole" runat="server" OnClick="lnkModifyRole_Click">修改角色</asp:LinkButton>
                                    </label>
                                </div>
                            </div>
                            <div id="user_list">
                                <asp:GridView ID="gvUsers" runat="server" Width="100%" AutoGenerateColumns="False"
                                    CellPadding="0" CellSpacing="0" PageSize="10" AllowPaging="True" DataKeyNames="userId">
                                      <PagerTemplate>
                                       <%-- 留空，彻底移除分页栏 --%>
                                    </PagerTemplate>
                                    <Columns>
                                        <asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="用户名">
                                             <ItemTemplate>
                                                 <a href="<%# "Employee_moreinfo.aspx?empId=" + Eval("userId").ToString() %>"><%# Eval("userId") %></a>
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="用户操作">
                                            <ItemTemplate>
                                                <a href="<%# "Employee_moreinfo.aspx?empId=" + Eval("userId").ToString() %>"><img src="image/icon_view.png" border="0" /></a>&nbsp;&nbsp;
                                                <a href="<%# "User_role_selectrole.aspx?empId=" + Eval("userId").ToString() %>"><img src="image/icon_configure.png" border="0" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
