<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post_weihu.aspx.cs" Inherits="ESM企业薪酬管理系统.Post_weihu" %>
                    ...
                    <td width="240" valign="top">
                        <div id="sub_navigation">
                            ...
                            <ul class="sub_navigation_links">
                                <li><asp:HyperLink ID="hlPostQuery" runat="server" NavigateUrl="Post_query1.aspx">岗位信息查询</asp:HyperLink></li>
                                <li><asp:HyperLink ID="hlPostMaintenance" runat="server" NavigateUrl="Post_weihu.aspx">岗位列表维护</asp:HyperLink></li>
                            </ul>
                        </div>
                    </td>
                        ...
                        <div id="sub_body">
                            ...
                            <div id="function_button">
                                <div id="item_noline" class="blue_btn">
                                    <a href="Post_add.aspx">新建岗位</a>&nbsp;&nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" OnClick="lnkDelete_Click" OnClientClick="return confirm('确定要删除选中的岗位吗？');">删除岗位</asp:LinkButton>&nbsp;
                                </div>
                            </div>

                            <div id="post_list">
                                <asp:GridView ID="gvPosts" runat="server" Width="100%" AutoGenerateColumns="False"
                                    CellPadding="0" CellSpacing="0" GridLines="None" AllowPaging="True" PageSize="10"
                                    >
                                 <PagerTemplate>
                                        <%-- 留空，彻底移除分页栏 --%>
                                      </PagerTemplate>
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="table_header_td" ItemStyle-Width="40">
                                            <HeaderTemplate>
                                     ...
                                     <asp:HiddenField ID="hfPostID" runat="server" Value='<%# Eval("postID") %>' />
                                        ...
                                        <asp:BoundField DataField="PostName" HeaderText="岗位名称" ItemStyle-CssClass="table_dashedline_td" />
                                        <asp:BoundField DataField="DeptName" HeaderText="所在部门" ItemStyle-CssClass="table_dashedline_td" />
                                        <asp:TemplateField HeaderText="岗位描述" ItemStyle-CssClass="table_dashedline_td" ItemStyle-Width="300">
                                            <ItemTemplate>
                                                <a href="<%# "Post_duty.aspx?name=" + HttpUtility.UrlEncode(Eval("postName").ToString()) %>" ><%# Eval("postDes") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="table_dashedline_td" ItemStyle-Width="60">
                                            <ItemTemplate>
                                                <a href="<%# "Post_update.aspx?postID=" + Eval("postID").ToString() %>">
                                                    <img src="image/icon_edit.png" border="0" alt="编辑" />
                                                </a>&nbsp;&nbsp;
                                                <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="image/icon_del.png" 
